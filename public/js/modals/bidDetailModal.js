// Capital Choice Platform - Bid Detail Modal (Improved)
...
const BidDetailModal = {
    ...
    // Get bid detail content (without header, with improvements)
    getBidDetailContent(bid, options = {}) {
        ...
        return `
            <div class="bid-detail-container">
                <!-- Project and Amount Summary (simplified) -->
    ...
    // Get action buttons (updated to include withdraw in both places)
    getActionButtons(bid, options) {
        ...
        // Withdraw button for bidder (appears in both places now)
    ...
    // Render file item (FIXED - removed NaN issue)
    renderFileItem(file) {
